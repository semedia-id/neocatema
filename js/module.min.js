/* to recompile this file, clear your grav cache */
...
/*to recompile this file,clear your grav cache*/
/*-module.min.js-*/
/*Compile Time:02/19/21 14:46:02*/
/*
...
match=true;
rgb={
r:parseInt(colorhexs[i].substr(0,2),16),g:parseInt(colorhexs[i].substr(2,2),16),b:parseInt(colorhexs[i].substr(4,2),16)
};
break;
}
}
...
ncol=hueToNcol(hue);
color={
red:rgb.r,green:rgb.g,blue:rgb.b,hue:hue,sat:sat,lightness:hsl.l,whiteness:hwb.w,blackness:hwb.b,cyan:cmyk.c,magenta:cmyk.m,yellow:cmyk.y,black:cmyk.k,ncol:ncol,opacity:a,valid:true
};
...
return{
red:0,green:0,blue:0,hue:0,sat:0,lightness:0,whiteness:0,blackness:0,cyan:0,magenta:0,yellow:0,black:0,ncol:"R",opacity:1,valid:false
};
}
...
fetch(action,{
method:method,body:new FormData(form)
})
...
var touchsurface=el,swipedir,startX,startY,distX,distY,threshold=el.clientWidth/4,//required min distance traveled to be considered swipe
...
swipedir=(distX<0)? 'left':'right' // ifdist traveled is negative,it indicates left swipe
...
swipedir=(distY<0)? 'up':'down' // ifdist traveled is negative,it indicates up swipe
}
}
